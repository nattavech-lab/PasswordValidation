...
public class TestRunner {
    ...
    public static void main(String[] a) {
        ...
        check("password len =20",PasswordValidator.validate("AaBcse12102030400000")==true );
        check("password len >20",PasswordValidator.validate("AaBcse121111111111111")==false );

        // TODO: R3 - ไม่มีตัวพิมพ์ใหญ่ -> false

          check(" password no upper",PasswordValidator.validate("aaaaabbb123")==false );
